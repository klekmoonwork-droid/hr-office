...
| สี | ความหมาย |
|---|---|
| เขียว | รันล่าสุดสำเร็จ และไม่มีรอบที่ตกหล่น |
| แดง | รันล่าสุดล้มเหลว — panel จะบอกว่าพังที่ขั้นตอนไหน |
| เหลือง | เลยเวลาที่ควรรันมาเกิน 3 ชม. แล้วยังไม่มี run / workflow ถูกปิดอยู่ |
| ฟ้า | กำลังรันอยู่ตอนนี้ |
| เทา | ยังไม่เคยรันเลย |
